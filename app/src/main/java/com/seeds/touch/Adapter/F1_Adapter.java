...
public class F1_Adapter extends RecyclerView.Adapter<F1_Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment1_item_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        CardView cardView = (CardView) holder.view.findViewById(R.id.home_card_view);
        ImageView image = (ImageView) holder.view.findViewById(R.id.home_item_image);
        ImageView sticker = (ImageView) holder.view.findViewById(R.id.home_item_sticker);
        TextView stickerLabel = (TextView) holder.view.findViewById(R.id.home_sticker_label);
        CircleImageView publisherPhoto = (CircleImageView) holder.view.findViewById(R.id.home_item_publisher_profile_photo);
        TextView publisherName = (TextView) holder.view.findViewById(R.id.home_item_publisher_name);
        TextView startDate = (TextView) holder.view.findViewById(R.id.home_item_start_date);
        TextView category = (TextView) holder.view.findViewById(R.id.home_item_category);
        TextView population = (TextView) holder.view.findViewById(R.id.home_item_attender_population_text);
